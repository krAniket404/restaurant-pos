...
const roles = [
  ...
  {
    id: "cashier",
    label: "Cashier's Dashboard",
    icon: CreditCard,
    color: "bg-green-500",
  },
  {
    id: "supervisor",
    label: "Supervisor's Dashboard",
            ...
            >
              <Card className="h-full transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 overflow-hidden border-0 bg-white/60 backdrop-blur-xl">
                <CardContent className="p-8 flex items-center space-x-6">
                  <div
                    className={`p-4 rounded-2xl text-white ${role.color} shadow-lg transition-transform duration-300 group-hover:scale-110`}
                  >
